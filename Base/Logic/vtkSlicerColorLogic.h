/*=auto=========================================================================
  ...
  Date:      $Date: 2011-01-07 15:39:48 -0500 (Fri, 07 Jan 2011) $
...
//ETX
  /// 
  /// load in a color file, creating a storage node. Returns 1 on
  /// success. Returns -1 if there's a file name clash, 0 on general loading failure.
