/*=========================================================================
  ...
  Date:      $Date: 2011-03-09 12:50:13 -0500 (Wed, 09 Mar 2011) $
  Version:   $Revision: 16169 $
...
// The Cameras module was meant to 
// allow swapping of cameras/views but never really worked.
// Enable it, but it will be in the Developer Tools section 
//#define CAMERA_DEBUG
...
#ifdef Slicer3_USE_CUDA
extern "C" int Vtkcuda_Init(Tcl_Interp *interp);
#endif
...
void printAllInfo(int argc, char **argv)
{
  ...
  fprintf(stdout, "<ProgramName version=\"$Revision: 16169 $\">%s</ProgramName>\n", argv[0]);
